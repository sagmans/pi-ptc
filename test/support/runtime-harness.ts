...
export const NEVER_SETTLING_TIMEOUT_MS = 100;
export const NEVER_SETTLING_DRAIN_TIMEOUT_MS = 30;
export const NEVER_SETTLING_TEST_TIMEOUT_MS = 500;
export const WORKER_TERMINATION_TIMEOUT_MS = 100;
export const WORKER_TERMINATION_DRAIN_TIMEOUT_MS = 300;
export const LATE_WORKER_ACTIVITY_DELAY_MS = 150;
export const WORKER_TERMINATION_TEST_TIMEOUT_MS = 1000;
